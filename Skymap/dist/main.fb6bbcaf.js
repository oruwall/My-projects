...
prev.addEventListener('click', prevSlide); ///end

var i = 0;

var activeSlide2 = function activeSlide2(n) {
  var _iterator2 = _createForOfIteratorHelper(slides2),
      _step2;
...
var prepareCurrentSlide2 = function prepareCurrentSlide2(ind) {
  activeSlide2(i);
};

var nextSlide2 = function nextSlide2() {
...
var prevSlide2 = function prevSlide2() {
  if (i == 0) {
    i = slides2.length - 1;
    prepareCurrentSlide2(i);
  } else {
...
var cards = document.querySelectorAll('.card__inner'); // you can use forEach here too
...
function btnClick() {
  ...
  [].forEach.call(cards, function (el) {
    ...
    if (el !== _this) el.classList.remove('is-flipped');
